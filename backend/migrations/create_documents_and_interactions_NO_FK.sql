-- Create DOCUMENTS and INTERACTIONS tables WITHOUT foreign keys
-- This avoids the "primary or unique key does not exist" error
...
-- Create DOCUMENTS table (no foreign key - avoids FK errors)
...
-- Create INTERACTIONS table (no foreign keys - avoids FK errors)
